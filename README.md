...
```
ホーム        累計貯金 / 今月の積立予定 / 未精算 / 最近のアクティビティ
貯金          月間集計 / 月末確定・ワンバンク入金ステータス / 試合記録 / 貯金ルール
割り勘        未精算サマリー / 精算（PayPay誘導）/ 支出登録 / メンバー管理
履歴          累計推移グラフ / 月次サマリー / カテゴリ別支出 / 統合タイムライン
マイページ    Marine ID / 表示名 / 外部アプリ起動URL / ログアウト
```
